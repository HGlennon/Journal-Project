...
const CalendarDateIcon: React.FC = () => {
  ...
  return (
    <div className="w-6 h-6 rounded-sm border border-gray-600 bg-gray-600 text-center text-[10px] font-semibold text-gray-800 flex flex-col overflow-hidden shadow-sm relative">
